...
#Change directory into the text one
#Cambio la directory nei file di testo
directory12 = os.getcwd().replace("Instagram-Downloader", r"\file-testo")
os.chdir(directory12)
...
print("Instagram Downloader -- by DanyB0")
