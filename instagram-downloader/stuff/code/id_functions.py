...
def chd_2():
    directory3 = direct + r"\stuff\file-testo"
    os.chdir(directory3)
    return directory3
...
def chd_3():
    direct2 = direct.replace(r"\instagram-downloader\stuff\imm","")
    os.chdir(direct2)
...
def insta(event):
    ...
    try:
        ...
        print(colorama.Fore.RED + "inexistent profile")
        messagebox.showerror("Inexistent Profile", "The profile does not exist.")
        print(colorama.Fore.WHITE)
    except instaloader.exceptions.PrivateProfileNotFollowedException:
        print(colorama.Fore.YELLOW + "the profile is private and not followed")
        ...
        print(colorama.Fore.YELLOW + "login needed")
        messagebox.showwarning("Login Needed", "To download posts from this profile you need to login.\nIt's been downloaded only the profile pic.")
        print(colorama.Fore.WHITE)
    except FileExistsError:
        print(colorama.Fore.YELLOW + "delete the folder with the profile pic.")
